...
def generate_embeddings(text):
    ...
    response = requests.post(f"{openai_endpoint}/openai/deployments/{values_env_openai['deployment']}/embeddings", headers=headers, json=data)
    ...
    if values_env_openai['index'] not in index_client.list_index_names():
        search_index = SearchIndex(
            ...
            fields=[
                ...
                SearchField(name="vector", type="Collection(Edm.Single)", filterable=False, facetable=False, searchable=True, dimensions=1536)  # Vector field with appropriate type and dimensions
            ],
